...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    Document documentA = new Document("Bag of Words (BoW) is a domain used in natural language processing. One aim of BoW is to categorize documents. The idea is to analyse and classify different “bags of words” (corpus). And by matching the different categories, we identify which “bag” a certain block of text (domain data) comes from.");
